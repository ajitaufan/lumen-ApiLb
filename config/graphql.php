...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'user'=> App\GraphQL\Query\daftarUser::class,
                'burungUser'=> App\GraphQL\Query\daftarBurungUserQuery::class,
                'jenis_lovebird'=> App\GraphQL\Query\daftarJenisLovebird::class,
                'searchBurung'=> App\GraphQL\Query\searchBurung::class,
                'wishlistUser'=> App\GraphQL\Query\wishlistUser::class,
              
               

            ],
            'mutation' => [
                'registerUser'=> App\GraphQL\Mutation\registerUser::class,
                'login'=> App\GraphQL\Mutation\login::class,
                'tambahBurung'=> App\GraphQL\Mutation\burung\tambahBurungMutation::class,
                'editBurung'=> App\GraphQL\Mutation\burung\editBurungMutation::class,
                'jualBurungSeller'=> App\GraphQL\Mutation\burung\jualBurungSellerMutation::class,
                'editProfil'=> App\GraphQL\Mutation\editProfil::class,
                'tambahJenisLovebird'=> App\GraphQL\Mutation\tambahJenisLovebird::class,
                'deleteBurung'=> App\GraphQL\Mutation\deleteBurung::class,
                'addWishlist'=> App\GraphQL\Mutation\addWishlist::class,
     ...
     */
    'types' => [
        'App\GraphQL\Type\user',
        'App\GraphQL\Type\burung',
        'App\GraphQL\Type\jenis_lovebird',
        'App\GraphQL\Type\image',
        'App\GraphQL\Type\wishlist',
    ],
